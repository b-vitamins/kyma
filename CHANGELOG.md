...
- Fixed the state-carry pretraining loop so multi-chunk TBPTT segments retain their graph only while the recurrent state is reused and then break graph carry across optimizer steps
